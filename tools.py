...
from dida365 import Dida365Client, TaskCreate, TaskUpdate, TaskPriority, ProjectCreate, ProjectUpdate, ViewMode, ProjectKind
...
# Single client instance and inbox cache
_client = None
_inbox_id = None
